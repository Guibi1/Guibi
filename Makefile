...
# Project:  Guibi.pro
# Template: lib
# Command: /home/guibi/Qt/5.10.1/gcc_64/bin/qmake -o Makefile Guibi.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DGUIBI_LIBRARY -DQT_DEPRECATED_WARNINGS -DQT_QML_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/guibi/Qt/5.10.1/gcc_64/lib -shared -Wl,-soname,libGuibi.so.1
...
Makefile: Guibi.pro ../../../Qt/5.10.1/gcc_64/mkspecs/linux-g++/qmake.conf ../../../Qt/5.10.1/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile Guibi.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
